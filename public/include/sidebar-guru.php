...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../dashboard/guru" class="brand-link">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="../dashboard/guru" class="d-block"><?= $hak_akses; ?></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="../dashboard/guru" class="nav-link <?php if ($activePage == "Guru") {
                                                                    echo "active";
                                                                } ?>">
                ...
                <li class="nav-item">
                    <a href="../absensi/absen-guru" class="nav-link <?php if ($activePage == "AbsensiGuru") {
                                                                        echo "active";
                                                                    } ?>">
