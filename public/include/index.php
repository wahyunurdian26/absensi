...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <!-- Notif Absen Masuk -->
    <script>
        $(document).on('click', '#btn-confirm-absen-masuk', function(e) {
            e.preventDefault();
            var link = $(this).attr('href');

            Swal.fire({
                title: 'Apakah Anda Yakin',
                text: 'Ingin melakukan absen hari ini?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
    ...
    <!-- Notif Absen Izin -->
    <script>
        $(document).on('click', '#btn-confirm-absen-izin', function(e) {
            e.preventDefault();
            var link = $(this).attr('href');

            Swal.fire({
                title: 'Apakah Anda Yakin',
                text: 'Ingin melakukan izin absen hari ini?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Ya, Izin Absen',
                cancelButtonText: 'Tidak'
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location = link;
    ...
    <!-- Notif Absen Izin -->
    <script>
        $(document).on('click', '#btn-confirm-pulang', function(e) {
            e.preventDefault();
            var link = $(this).attr('href');

            Swal.fire({
                title: 'Apakah Anda Yakin',
                text: 'Sudah melakukan absen hari ini?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
    ...
    <!-- Notif Absen Izin -->
    <script>
        $(document).on('click', '#btn-confirm-reset-data', function(e) {
            e.preventDefault();
            var link = $(this).attr('href');
